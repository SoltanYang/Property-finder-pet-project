class PropertiesController < ApplicationController
  ...
  def set_sidebar
    ...
    def property_params
      params.require(:property).permit(:name, :address, :price, :rooms, :bathrooms, :photo, :status,
                                       :photo_cache, :parking_spaces, :details, :for_sale, :available_date)
    end
end
